...
- `expected_policy.json` — Expected outcome: `accepted_with_caveats` with mapping-proximity warnings; feature handoff ready and automatic pathway roll-up disallowed.
